 ...
 * needed to restore one freehanddrawing qtype plugin
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_freehanddrawing_plugin extends restore_qtype_plugin {
    ...
    /**
     * Process the qtype/freehanddrawing element
     */
    public function process_freehanddrawing($data) {
        global $DB;
