...
(function () {
    ...
    quote = function ($0) {
        ...
        return ( escapable.test($0) ? '"' + $0.replace(escapable, function ($0) {
            var $1 = meta[$0];
            return typeof $1 === "string" ? $1 : "\\u" + ("0000" + $0.charCodeAt(0).toString(16)).slice(-4)
        }) + '"' : '"' + $0 + '"')
    };
    str = function ($0, $1) {
        var $2, $3, $4, $5, $6 = gap, $7, $8 = $1[$0];
        if ($8 && typeof $8 === "object" && typeof $8.toJSON === "function") {
            $8 = $8.toJSON($0)
        }
        ;
        ...
        switch (typeof $8) {
            ...
            case "object":
                ...
                gap += indent;
                $7 = [];
                if (Object.prototype.toString.apply($8) === "[object Array]") {
                    $5 = $8.length;
                    for ($2 = 0; $2 < $5; $2 += 1) {
                        $7[$2] = str($2, $8) || "null"
                    }
    ...
    if (typeof JSON.stringify !== "function") {
        JSON.stringify = function ($0, $1, $2) {
            ...
            ;rep = $1;
            if ($1 && typeof $1 !== "function" && (typeof $1 !== "object" || typeof $1.length !== "number")) {
    ...
    if (typeof JSON.parse !== "function") {
        JSON.parse = function ($0, reviver) {
            ...
            if (new RegExp("^[\\],:{}\\s]*$").test($0.replace(new RegExp('\\\\(?:["\\\\\\/bfnrt]|u[0-9a-fA-F]{4})', "g"), "@").replace(new RegExp('"[^"\\\\\\n\\r]*"|true|false|null|-?\\d+(?:\\.\\d*)?(?:[eE][+\\-]?\\d+)?', "g"), "]").replace(new RegExp("(?:^|:|,)(?:\\s*\\[)+", "g"), ""))) {
                $1 = eval("(" + $0 + ")");
                return typeof reviver === "function" ? walk({"": $1}, "") : $1
            }
            ;
...
;lz.sendEvent = function (name, value) {
    ...
    try {
        ...
        (function () {
            var callobj = {destination: window.parent, publicProcedureName: "asyncCallback", params: [window.name, name, value]};
...
lz.rte = {};
lz.rte.util = {
    loadJavascript: function ($0, $1, $2) {
        var $3 = $0.createElement("script");
        $3.src = $1;
        $3.type = "text/javascript";
        if ($2) {
            $3.onload = $2;
            $3.onreadystatechange = $2
        }
        ;$0.getElementsByTagName("head")[0].appendChild($3)
    }, loadCSS: function ($0, $1) {
        var $2 = $0.createElement("link");
        $2.rel = "stylesheet";
        $2.type = "text/css";
        $2.href = $1;
        $0.getElementsByTagName("head")[0].appendChild($2)
    }
};
lz.rte.loader = {
    __loading: false,
    ...
    loadDojoCSS: function ($0, $1) {
        lz.rte.util.loadCSS($0, lz.rte.loader.__dojoroot + lz.rte.loader.__csspath + $1 + "/" + $1 + ".css");
        lz.rte.util.loadCSS($0, lz.rte.loader.__dojoroot + "/dojox/editor/plugins/resources/css/Smiley.css");
        document.body.className += document.body.className ? " " + $1 : $1
    },
    loadDojo: function ($0, $1, $2) {
        if (lz.rte.loader.__loading) {
            lz.rte.loader.__callbacks.push($1);
            return
    ...
    editor_loaded: function () {
        ...
        while (lz.rte.loader.__callbacks.length > 0) {
            var $0 = lz.rte.loader.__callbacks.shift();
            $0.call()
        }
    }
};
lz.rte.manager = {
    ...
    __rte_start: function ($0) {
        ...
        var $1 = dojo.byId(lz.rte.manager.__id);
        if ($0 && $1) $1.innerHTML = $0;
        if (lz.rte.manager.__editor) {
            lz.rte.manager.__editor.open()
        } else {
            var $2 = lz.rte.manager.__plugins;
            var $3 = lz.rte.manager.__extraplugins;
            $3.push("dijit._editor.plugins.AlwaysShowToolbar");
            lz.rte.manager.__editor = new (dijit.Editor)({height: "100%", plugins: $2, extraPlugins: $3}, $1);
    ...
    rte_start: function ($0) {
        if (lz.rte.manager.isEditing() || lz.rte.manager.__loading) return;
        if (lz.rte.manager.isLoaded()) {
            lz.rte.manager.__rte_start($0)
        } else {
            lz.rte.manager.__text = $0;
            lz.rte.manager.initialize()
        }
    },
    rte_stop: function () {
        var $0;
        if (lz.rte.manager.__editor) {
            $0 = lz.rte.manager.getText();
            if (lz.rte.manager.isEditing()) lz.rte.manager.__editor.close()
        }
        ;
        return $0
    },
    setText: function ($0) {
        if (lz.rte.manager.__editor) {
            var $1 = lz.rte.manager.__editor.get("value").length == 0;
            if ($0.indexOf("<p") != 0 && $0.indexOf("<P") != 0) {
                $0 = "<p>" + $0 + "</p>"
            }
            ;
            if ($1) {
    ...
    getText: function () {
        var $0;
        if (lz.rte.manager.__editor) {
            $0 = lz.rte.manager.__editor.get("value");
            if (($0.indexOf("<p>") == 0 || $0.indexOf("<P>") == 0) && ($0.lastIndexOf("</p>") == $0.length - 4 || $0.lastIndexOf("</P>") == $0.length - 4)) {
    ...
    onchange: function ($0) {
        var $1 = lz.rte.manager.getText();
        if ($1 != lz.rte.manager.__text) {
            lz.rte.manager.__text = $1;
            lz.sendEvent("_text", $1)
        }
    },
    rte_loaded: function () {
    ...
    editor_loaded: function () {
        if (lz.rte.manager.isLoaded()) return;
    ...
    setDojoPath: function ($0, $1, $2) {
        lz.rte.loader.__dojoroot = $0;
        lz.rte.loader.__jspath = $1;
        lz.rte.loader.__csspath = $2;
    ...
    addButton: function ($0) {
        ...
        if (dojo.byId(id)) dojo.destroy(id);
        var $1 = {
            id: id, type: "button", onclick: function () {
        ...
        ;dojo.create("input", $1, dojo.byId("rte_buttons"), "last");
        dijit.byId("rte_div").resize();
        return id
    }
};