...
class Browser {
     ...
     */
    public function isNexus7() {
        return strpos($this->_agent, "Nexus 7") !== false;
    }
    ...
    protected function checkBrowserInternetExplorer() {
        ...
        if (stripos($this->_agent, 'microsoft internet explorer') !== false) {
            ...
            if (stripos($this->_agent, 'ARM') !== false && stripos($this->_agent, 'MSIE') != false &&
                    stripos($this->_agent, 'TOUCH') != false) {
    ...
    protected function checkBrowserMozilla() {
        if (stripos($this->_agent, 'mozilla') !== false && preg_match('/rv:[0-9].[0-9][a-b]?/i', $this->_agent) &&
            ...
            return true;
        } else if (stripos($this->_agent, 'mozilla') !== false && preg_match('/rv:[0-9]\.[0-9]/i', $this->_agent) &&
                stripos($this->_agent, 'netscape') === false) {
            $aversion = explode('', stristr($this->_agent, 'rv:'));
            $this->setVersion(str_replace('rv:', '', $aversion[0]));
            $this->setBrowser(self::BROWSER_MOZILLA);
            return true;
        } else if (stripos($this->_agent, 'mozilla') !== false && preg_match('/mozilla\/([^ ]*)/i', $this->_agent, $matches) &&
                stripos($this->_agent, 'netscape') === false) {
            $this->setVersion($matches[1]);
            $this->setBrowser(self::BROWSER_MOZILLA);
            return true;
    ...
    protected function checkBrowserSafari() {
        if (stripos($this->_agent, 'Safari') !== false && stripos($this->_agent, 'iPhone') === false &&
