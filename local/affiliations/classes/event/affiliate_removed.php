...
class affiliate_removed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has removed their association with the affiliate " .
            "'$this->other->affiliatename' with a cohort id of '$this->other->cohortid'. The user has been removed from the cohort '$this->other->cohortname'.";
    }
    ...
    public static function get_name() {
        return get_string('eventaffiliateremoved', 'local_affiliations');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('remove affiliate', 'Remove affiliate');
